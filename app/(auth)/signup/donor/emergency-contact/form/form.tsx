    ...
    return (
        <div className="w-full ">
            ...
            <div className="mt-[40px] flex gap-[25px]">
                <div onClick={() => router.push("/signup/donor/skills-and-availability")} className="cursor-pointer py-[8px] px-[31px] border-2 border-[#026935] text-[#026935] rounded-[10px] font-semibold w-max">
                    Previous
                </div>
