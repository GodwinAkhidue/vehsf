...
export default function Form() {
  ...
  useEffect(() => {
    setData((prev: any) => ({ ...prev, role: "donor" }));
  }, []);
  ...
  return (
    <div className="w-full">
      ...
      <div className="mt-[20px] lg:mt-[30px]">
        <div className="font-medium text-[14px] lg:text-base">Address</div>
        <div className="border border-[#00000080] rounded-[7px] px-[25px] py-[15px] flex items-center w-full gap-[10px] mt-[10px]">
          <FaLocationDot className="text-[#00000080] text-[18px]" />
          <input
            name="address"
            placeholder="2, Lorem Ipsum Ave"
            type="address"
            className="w-full h-full outline-none"
        ...
        setLanguagesSpoken={(e: any) => {
          setData((prev: any) =>
            prev.languages_spoken.includes(e)
              ...
              : {
                  ...prev,
                  languages_spoken: [...prev.languages_spoken, e],
                }
          );
        }}
      />
      ...
      <div
        onClick={() => router.push("/signup/donor/create")}
