...
export default function Form() {
    ...
    return (
        <div className="w-full ">
            ...
            <div onClick={() => router.push("/signup/donor/skills-and-availability")} className="cursor-pointer py-[10px] px-[33px] bg-[#026935] text-white rounded-[10px] mt-[40px] font-semibold w-max">
                Next
            </div>
        </div>
    );
