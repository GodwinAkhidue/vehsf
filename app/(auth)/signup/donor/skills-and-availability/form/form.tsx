    ...
    return (
        <div className="w-full ">
            ...
            <div className="mt-[40px] flex gap-[25px]">
                <div onClick={() => router.push("/signup/donor/personal-info")} className="cursor-pointer py-[8px] px-[31px] border-2 border-[#026935] text-[#026935] rounded-[10px] font-semibold w-max">
                    Previous
                </div>
                <div onClick={() => router.push("/signup/donor/emergency-contact")} className="cursor-pointer py-[10px] px-[33px] bg-[#026935] text-white rounded-[10px] font-semibold w-max">
                    Next
                </div>
            </div>
        </div>
