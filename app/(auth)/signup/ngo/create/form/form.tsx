    ...
    return (
        <div className="w-full">
            ...
            <div className="mt-[20px] flex flex-col lg:flex-row gap-[10px] lg:gap-[25px]">
                <div onClick={() => router.push("/signup/ngo/ngo-info")} className="cursor-pointer py-[8px] px-[31px] border-2 border-[#026935] text-[#026935] rounded-[10px] font-semibold w-max">
                    Previous
                </div>
                <button
