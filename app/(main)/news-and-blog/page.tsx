            ...
            <div className="w-full max-w-[1050px]">
                <div className="flex items-center justify-center gap-[25px]">
                    <div className="hidden lg:flex w-[240px] h-[240px] rounded-[20px] overflow-hidden relative">
                        <Image src={'/images/news-and-blog/1.jpg'} alt="vehsf" fill className="object-cover" />
                    </div>
                    <div className="hidden lg:flex w-[120px] h-[160px] rounded-[20px] overflow-hidden relative">
                        <Image src={'/images/news-and-blog/2.jpg'} alt="vehsf" fill className="object-cover" />
                    </div>
                    <div className="text-[#254229] text-[32px] lg:text-[42px] font-semibold">
                        News/Blog
                    </div>
                    <div className="hidden lg:flex w-[120px] h-[160px] rounded-[20px] overflow-hidden relative">
                        <Image src={'/images/news-and-blog/3.jpg'} alt="vehsf" fill className="object-cover" />
                    </div>
                    <div className="hidden lg:flex w-[240px] h-[240px] rounded-[20px] overflow-hidden relative">
                        <Image src={'/images/news-and-blog/4.jpg'} alt="vehsf" fill className="object-cover" />
                    </div>
                </div>
                <div className="text-center mt-[10px] max-w-[520px] justify-self-center">
                    Stay up to date with our latest news, inspiring stories, upcoming events,
                    and impact reports as we work together to change lives and transform
                    communities
                </div>
                <Blogs />
                <Stories />
