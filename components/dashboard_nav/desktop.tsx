...
const Page = ({ logout }: { logout: any }) => {
  ...
  return (
    <div
      className={`mt-[10px] hidden lg:block bg-white border border-[#E6EDFF] rounded-r-[10px] ${
        expandNav ? "px-[40px] w-[250px]" : "px-[30px] w-[70px]"
      } transition-all duration-300 overflow-hidden py-[50px]`}
    >
      <div
      ...
      <div className="flex flex-col gap-[20px] mt-[30px]">
        ...
        <div
          className={`my-[10px] h-[1px] w-[190px] ${
            expandNav ? "bg-[#C4C4C4]" : "bg-transparent"
          }`}
        ></div>
        <button
        ...
        <button
          ...
          className="flex items-center gap-[20px]"
        >
          <MdOutlineLogout className="text-[20px] shrink-0" />
          <div className="text-[14px] font-semibold whitespace-nowrap">
            Logout
          </div>
        </button>
