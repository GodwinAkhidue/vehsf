  ...
  return (
    <div className="bg-white text-[#121212] poppins lg:hidden">
      <div
        ...
        className={`${
          showNav
            ? "w-[120px] duration-300 delay-100 fixed"
            : "w-[22px] duration-200 absolute"
        } transition-all top-[23px] left-[15px] z-[52] text-[20px] cursor-pointer flex items-center gap-[5px] overflow-hidden`}
      >
      ...
      <div
        className={`fixed top-0 left-0 w-full h-full z-[51] ${
      ...
      >
        <div
          ...
          className={`${
            showNav ? "bg-[#00000080] " : "bg-transparent"
          } transition-all duration-300 absolute top-0 left-0 w-full h-full cursor-pointer`}
        ></div>
        <div
          className={`bg-white border border-[#E6EDFF] rounded-r-[10px] absolute top-0 ${
            showNav ? "left-0" : "-left-[100%]"
          } transition-all duration-300 w-full h-full max-w-[315px] pl-[15px] flex flex-col gap-[20px] pt-[70px]`}
        >
          {links.map((i, index) => (
            <Link
              href={i.link}
          ...
          <div className="my-[10px] h-[1px] bg-[#C4C4C4] w-[190px]"></div>
          <button
            onClick={() => addQueryProfile()}
            className="flex items-center gap-[5px]"
          >
          ...
          >
            ...
            <div className="text-[14px] font-semibold">Logout</div>
          </button>
        </div>
      </div>
    </div>
